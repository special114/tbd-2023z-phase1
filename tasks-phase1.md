...
11. Draw an architecture diagram (e.g. in draw.io) that includes:
    ...
    ![task_7 drawio](https://github.com/special114/tbd-2023z-phase1/assets/51239039/b6d1252f-c5a4-4bd0-bb5e-9c9fb294e0f9)

    Port dla drivera to 16384. Podanie hosta jest konieczne aby workery wiedziały z jakim węzłem się komunikować to znaczy gdzie wysyłać wyniki swojej pracy. Wynika to z rozproszonej
    natury obliczeń w Apache Spark.

13. Add costs by entering the expected consumption into Infracost
